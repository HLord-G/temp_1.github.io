  ...
  let datacompiler = [
    {
        code:`
        <nav scroll-logic-add='100,class,bg-base-300' class="fixed flex flex-row w-full p-[10px] py-[20px] transition duration-300 px-[50px] max-[666px]:px-[20px] z-[99] justify-between items-center overflow-hidden"> <!-- bg-base-300  -->
                <div>
                  <h1 class="font-black text-3xl"><a href="index.html">TELA BORDS</a></h1>
                </div>
                <div>
                  <h1 menuview="true" event-class-click="openmenu" event-toggle="true" eventid="openmenu" ev-do-update="hidden"  popup_opn="openpops" popup_opn_ani="fade-in-right" class="text-2xl text-base-content cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" height="44px" viewBox="0 -960 960 960" width="44px" fill="currentColor"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>
                  ...
                  <h1  class="hidden" event-class-click="openmenu" event-toggle="true" ev-do-update="text-2xl text-base-content cursor-pointer" popup_cls="openpops" popup_cls_ani="slide-out-right" eventid="openmenu">
          <svg xmlns="http://www.w3.org/2000/svg" height="44px" viewBox="0 -960 960 960" width="44px" fill="currentColor"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg>
              ...
              <aside popup="openpops" openview="false" popstyle="fixed" popindex="9" navbar="true" class="fixed hidden bg-base-300 flex-col top-0 left-0 overflow-hidden w-full h-full p-[10px] py-[20px] transition duration-300 px-[60px] max-[666px]:px-[20px] z-[90] justify-center items-start gap-[30px]">
                  <div class="fixed flex flex-col top-0 left-0 overflow-hidden w-full h-full p-[10px] py-[20px] transition duration-300 px-[60px] max-[666px]:px-[20px] z-[90] justify-center items-start gap-[30px]">
                    <a href="index.html"> 
                      <h2 class="text-5xl">
                        Home
                      </h2> 
    ...
    {
      code:`    <section class="flex flex-row p-[10px] justify-center items-center min-h-[100vh] max-[782px]:flex-col-reverse" style="background: #2d5433; background: radial-gradient(circle, rgba(45, 84, 51, 1) 25%, rgba(16, 23, 17, 1) 100%);">
...
`
    ...
    {
      code:`    <section class="flex flex-row justify-center items-center min-h-[100vh] max-[716px]:min-h-[10vh] gap-[10px] p-[20px] my-[120px] max-[888px]:flex-col">
...
`
    ...
    {
      code:` <section class="min-h-[100vh] w-full flex flex-col justify-start items-center mb-[200px]">
        ...
        <main class=" w-[90vw] flex flex-col justify-start items-center">
            ...
            <img src="https://dummyimage.com/1260x735" class="object-cover object-center h-[735px] mb-[80px]" alt="">

            <article class="text-lg flex flex-col justify-center items-center text-center space-y-10">
                    <h1 class="text-4xl font-bold">
                        About us
                    </h1>

                    <p>
                        film find fight blow poetry black son protection heard safe oxygen cabin while figure promised parts herd rice barn cage tape making package heading.
                        football recent bee save cow eye draw upper bend appearance chart fun bite raise pretty entire impossible continent surface back neighbor inside station hit
                    </p>

                    <p>
                        closely pick waste drove able wall quick quite sharp mission iron advice milk feed possibly industry rock seldom care tail effect camera when among
                    </p>

                    <div>
                        <button class="btn btn-lg px-[20px]">
                            Join us
                        </button>
                    </div>
            </article>
    ...
    },
    {
      code:`
          <section>
      <div class="mt-[20px] flex flex-row justify-center relative mb-[10px]">
        <h2 class="mb-[20px] w-[90vw] text-2xl text-base-content/60">
          A network of over 100 trusted clients around the world.
        </h2>
      </div>
      <div class="flex justify-center items-center w-full  mb-[120px]">
  
          <swiper-container attr_size_changer="('[slides-per-view]', 715, '1')"  flexboy_id="sliders" class="w-[90vw] max-[726px]:w-full"  slides-per-view="2" centered-slides="true" space-between="30" pagination="true"
      ...
      code:`    <section attr_size_changer="('[style]', 425, 'zoom:.9;'), ('[style]', 336, 'zoom:1;')" class="mt-[20px] relative flex flex-col justify-center items-center mb-[120px]">
        <div class="flex flex-row justify-center items-start w-[90vw] min-h-[40vh] p-[30px] max-[506px]:p-[6px] bg-[#4d5959]">
            <div class="flex-2 w-full">
                ...
                <div attr_size_changer="('[style]', 584, 'display: grid; grid-template-columns: 1fr; grid-template-rows: repeat(5, 1fr); grid-column-gap: 0px; grid-row-gap: 0px;')" class="form_flexboy w-full max-[416px]:p-[6px] p-[20px] max-[666px]:scale-[.9] max-[584px]:scale-[1]" style="display: grid; grid-template-columns: repeat(2, 1fr); grid-template-rows: repeat(3, 1fr); grid-column-gap: 0px; grid-row-gap: 0px;">

                    <div attr_size_changer="('[style]', 584, 'grid-area: 1 / 1 / 2 / 2;')" style="grid-area: 1 / 1 / 2 / 2;" class="label_flexboy1 p-[5px] m-[5px]">
                    ...
                    <div attr_size_changer="('[style]', 584, 'grid-area: 2 / 1 / 3 / 2;')" style="grid-area: 1 / 2 / 2 / 3;" class="label_flexboy2 p-[5px] m-[5px] w-full">
                    ...
                    <div attr_size_changer="('[style]', 584, 'grid-area: 3 / 1 / 4 / 3;')" style="grid-area: 2 / 1 / 3 / 2;" class="label_flexboy3 p-[5px] m-[5px] w-full">
                      <fieldset class="fieldset">
                    ...
                    <div attr_size_changer="('[style]', 584, 'grid-area: 4 / 1 / 5 / 2;')" style="grid-area: 2 / 2 / 3 / 3;" class="label_flexboy4 p-[5px] m-[5px]">
                      <fieldset class="fieldset">
                    ...
                    <div attr_size_changer="('[style]', 584, 'grid-area: 5 / 1 / 6 / 2;')" style="grid-area: 3 / 1 / 4 / 3;" class="label_flexboy5 p-[5px] m-[5px]">
    ...
    {
      code:`    <section class="flex flex-col justify-center items-center w-full my-[120px] mb-[120px]">
      ...
      code:`    <section class="bg-[#4d5959] w-full min-h-[100vh] py-[90px] px-[20px]">
    ...
    },
    {
      ...
      <div class="min-h-[40vh] p-[20px] py-[30px] flex flex-row max-[564px]:flex-col max-[564px]:mb-[60px]">
        <div class="flex-2"> 
            <div class="mb-[20px]">
      ...
      <div class="flex flex-row justify-between items-center px-[30px] py-[20px] max-[763px]:flex-col">
      <div class="flex flex-row justify-center items-center text-center">
          <p>© This is a Masterthemes template powered by <a href="https://www.flexboy.online/" class="btn btn-link text-md text-base-content p-[0px] m-[0px] text-[15px]">Flexboy</a></p>
      </div>
      ...
      code:`
      <section class="bg-[#4d5959] w-full min-h-[100vh] my-[120px] py-[90px] px-[20px]">

        <article class="mb-[20px] flex flex-row justify-center items-center">
        ...
        <div class="flex flex-row justify-center items-start gap-[30px] flex-wrap" style="zoom:.8;">
          ...
          <a href="#">
            <aside class="p-[15px] card w-96 shadow-sm cursor-pointer">
              <figure>
                <img src="https://dummyimage.com/353x400" class="w-full rounded-2xl h-[400px]" alt="">
              </figure>
           
              <div class="gap-[5px] flex flex-col mt-[15px] p-[10px] text-center">
                <h1 class="text-3xl font-bold">
                  <a href="explain.html">Harold Guzman</a>
                </h1>
                <p class="text-base-content/70">
                    Co Founder
                </p>
                <div class="mt-[20px] flex flex-row justify-around items-center">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                            <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                        </svg>
      ...
      code:`
        ...
        <article class="my-[90px] flex flex-row justify-center items-center">
          <h1 class="text-7xl font-bold text-center max-[432px]:text-5xl">
            From <span class="text-base-content/50">blog</span>
          </h1>
        </article>
...
datacompiler.forEach((item, index) => {
  ...
  wrapper.className = "mb-[30px] shadow-2xl";
